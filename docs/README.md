...
| [Latest verification results](VERIFICATION_RESULTS.md) | Recorded behavioral-test, Leonardo compile, resource-usage, and validation-scope results with GitHub Actions references. |
